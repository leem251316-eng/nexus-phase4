...
BOT_CONFIGS = {
    "NUGT": {
        ...
        "recipe": {
            ...
            # V1.4: avoid_hours from strategy_recipes.json (worst_hours, 8840-trade backtest)
            "avoid_hours": [11, 9], "avoid_days": [],
        },
    ...
    "SOXL": {
        ...
        "recipe": {
            ...
            # V1.4: avoid_hours from strategy_recipes.json
            "avoid_hours": [8, 13], "avoid_days": [],
        },
        "ride_stop_mult":     1.3,
        "ride_trail_mult":    1.5,
        "ext_stop_mult":      1.8,
    ...
    "TQQQ": {
        ...
        "recipe": {
            ...
            # V1.4: avoid_hours from strategy_recipes.json (63.7% WR -- best of 4)
            "avoid_hours": [9, 10], "avoid_days": [],
        },
        "ride_stop_mult":     1.3,
        "ride_trail_mult":    1.5,
        "ext_stop_mult":      2.0,
        ...
        if res.status_code == 200:
            ...
            for asset in assets:
                if asset.get("currency") == "USD":
                    ...
                    # V1.4: fallback to option_buying_power for debit-card funded accounts
...
def run():
    ...
    start_server(bots)
    alert("⚡ PHASE4 V1.4 ONLINE | NUGT+SOXL+LABU+TQQQ | QQQ filter active | Win-rate gate live")
