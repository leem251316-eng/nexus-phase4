"""
NEXUS PHASE 4 — PER-SYMBOL AUTONOMOUS BOTS V1.8
...
# Suppress yfinance DeprecationWarning spam about NumPy timedelta 'generic' unit.
# This comes from yfinance internals, not our code -- purely cosmetic noise in logs.
warnings.filterwarnings("ignore", category=DeprecationWarning, module="yfinance")

# V1.8: Ensure the app directory is on sys.path so phase4_server (which lives
# alongside phase4.py in the nexus-phase4 repo) is always importable regardless
# of how Railway invokes the entry point. Without this, a late `from phase4_server
# import start_server` inside run() fails with ModuleNotFoundError even though
# the file is physically present in /app/.
...
# Import phase4_server at module level so a missing file fails on boot,
# not after all bots have started. sys.path fix above ensures it resolves.
from phase4_server import start_server as _start_server
